...
<template>
    <div v-if="authUser" class="flex gap-2 mb-3">
        ...
        <div class="flex flex-1">
            ...
            <IndigoButton @click="createComment" class="rounded-l-none w-[100px] ">Subir</IndigoButton>
        </div>
    </div>
    <div>
            ...
            <div class="pl-12">
                <div v-if="editingComment && editingComment.id === comment.id">
                    ...
                    <div class="flex gap-2 justify-end">
                        <button @click="editingComment = null" class="rounded-r-none text-indigo-500">cancelar
                        </button>
                        <IndigoButton @click="updateComment" class="w-[100px]">actualizar
                        </IndigoButton>
                    </div>
                </div>
